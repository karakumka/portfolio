...
cross_corr = pd.DataFrame([cross_correlations_Y1[0][1:], cross_correlations_Y2[0][1:]], columns=df_continuous.columns, index=['Y1', 'Y2'])
cross_corr
...
#        print(f"Point {i+1}: PCA = ({Y[i, 0]:.2f}, {Y[i, 1]:.2f}), Radius = {radius[i]:.2f}")
