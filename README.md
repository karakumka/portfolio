...
- Backend & MLOps: FastAPI/Starlette, Uvicorn, FastMCP/MCP, REST/HTTP, JSON, интеграция с внешними API; Docker
...
### [Приложение для автоматического разбора и структурирования сценариев](https://github.com/karakumka/portfolio/tree/main/Project4)

Реализован полный NLP-пайплайн для автоматического разбора сценариев (PDF/DOCX) в структурированную таблицу: сегментация на сцены, извлечение персонажей, массовки, реквизита, костюма, декораций, транспорта и др. на основе ансамбля правил и дообученных трансформеров (`ruRoBERTa`). Backend упакован в Docker и развёрнут на сервере; десктопное приложение под Windows отправляет файлы на сервер и возвращает готовый Excel с результатами разбора. Решение подготовлено в рамках хакатона ***Wink AI Challenge*** (финалист).
...
10/2024 - 09/2025 - **Data Scientist** @ ASPRONA Albacete / U4Impact (Испания)
...
- Обрабатывала и моделировала гетерогенные наборы данных: очистка, построение признаков, визуализация и кластеризация. Провела анализ психометрической шкалы INICO-FEAPS для сегментации участников и количественной оценки эффектов вмешательства
...
12/2020 - 05/2023 — **Аналитик медиа / Политический аналитик** @ *АНО "Диалог Регионы"*
